...
namespace ProyectoGestionVenta.Controllers
{
    public class ProveedorsController : Controller
    {
        ...
        public ProveedorsController(GestionVentasContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProveedorId,Correo,ArticuloId,Representante,Direcion,Contactos")] Proveedor proveedor)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'GestionVentasContext.Proveedors'  is null.");
            }
            var proveedor = await _context.Proveedors.FindAsync(id);
            if (proveedor != null)
            {
